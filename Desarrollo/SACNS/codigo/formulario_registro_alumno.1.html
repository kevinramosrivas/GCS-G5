            ...
            <div class="container py-5">
                ...
                <div class="container mx-lg-5" id="containerLoginPageRight">
                    <div>
                        ...
                        <p class="text-secondary" id="textLoginPage">Hola, "nombre", ingrese los datos del nuevo usuario alumno.</p>
                    </div>
                </div>
                ...
                <div class="container mx-lg-5" id="containerLoginPageRight">
                    ...
                    <form>
                        ...
                        <div class="mb-1">
                            ...
                            <input type="text" class="form-control" placeholder="DNI" pattern="[0-9]{8}" required />
                        </div>
                        <div class="mb-1">
                            <p class="label-color mb-1">Numero de Telefono*</p>
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" placeholder="999 - 999 - 999" pattern="[0-9]{9}" required/>
                            </div>
                        ...
                        <div class="mb-1">
                            ...
                            <select class="form-select select text-secondary">
                                ...
                                <option>1ero de Secundaria</option>
                                <option>2do de Secundaria</option>
                                <option>3ero de Secundaria</option>
